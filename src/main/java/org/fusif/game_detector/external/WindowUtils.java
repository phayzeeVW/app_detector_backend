 ...
 */
package org.fusif.game_detector.external;
...
public class WindowUtils {
    ...
    private static class W32WindowUtils extends NativeWindowUtils {
        ...
        public String getProcessFilePath(final HWND hwnd) {
            ...
            if (process == null) {
                if((Kernel32.INSTANCE.GetLastError() != WinNT.ERROR_ACCESS_DENIED) && (Kernel32.INSTANCE.GetLastError() != WinNT.ERROR_INVALID_PARAMETER)) {
                    throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
                } else {
